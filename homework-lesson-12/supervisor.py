...
from agents.utils import create_agent, HumanInTheLoopMiddleware, fetch_prompt
...
supervisor = create_agent(
    ...
    system_prompt=fetch_prompt("supervisor_prompt"), # Завантаження промпту з Langfuse
